...
vendor = st.sidebar.selectbox('Select Vendor', sales_df['Vendor'].unique())
product_type = st.sidebar.selectbox('Select Product Type', sales_df['Handle'].unique())

# Filtered data based on selection
filtered_sales = sales_df[(sales_df['Vendor'] == vendor) & (sales_df['Handle'] == product_type)]

# Assuming you have a date column or generating a simulated date sequence
